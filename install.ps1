...
<#
.SYNOPSIS
    Antigravity Backup - Instalador para Windows Server
...
$TaskName   = "AntigravityBackup"
$ScriptPath = Join-Path $ScriptDir "antigravity_backup.py"
...
try {
    Register-ScheduledTask -TaskName $TaskName -Action $Action -Trigger $Trigger -Settings $Settings -Principal $Principal -Description "Antigravity Backup - Copia de seguridad automatizada" -Force | Out-Null
